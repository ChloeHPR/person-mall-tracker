...
Here are some results generated by the script from video footage.

### Example 1
* **Target:** `man` + `light blue clothing` + `shirt`
* **Confidence Score:** `72.71%`

<img src="examples/example1.jpg" width="300" alt="Man in a blue shirt">


### Example 2
* **Target:** `Man` + `Red clothing` + `shirt`
* **Confidence Score:** `58.36%`

<img src="examples/example2.jpg" width="300" alt="Man in red shirt">
